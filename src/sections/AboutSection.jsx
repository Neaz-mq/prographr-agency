  ...
  return (
    <div ref={containerRef} className={`flex flex-col gap-0 ${className}`}>
      {headingLines.map((line, li) => (
        <p key={li} className="leading-[1.2] tracking-[0.01em]" aria-label={line}>
...
export default function AboutSection() {
  ...
  if (!isDesktop) {
    return (
      <section id="about" className="bg-white w-full">
        <div ref={headingRef} className="max-w-7xl mx-auto px-5 sm:px-8 w-full pt-4 pb-8">
  ...
  return (
    <div id="about" ref={wrapperRef}>
      <section ref={sectionRef} className="bg-white w-full overflow-hidden flex flex-col">
        <div ref={headingRef} className="w-full shrink-0 px-3 md:px-[2.5rem] 3xl:px-[26rem] 2xl:px-[10rem] xl:px-[5rem] lg:px-[4rem] pt-6 3xl:pb-32 pb-5">
        ...
        <div className="w-full overflow-hidden relative 3xl:h-[800px] 2xl:h-[600px] xl:h-[320px] lg:h-[360px]">
          <div ref={cardsWrapRef} className="flex items-stretch h-full will-change-transform" style={{ width: "max-content" }}>
            {/* Card 0 */}
            <div className="shrink-0 flex items-start pl-3 md:pl-10 3xl:pl-[26rem] 2xl:pl-40 xl:pl-20 lg:pl-16 pt-2 pb-5">
              <div className="3xl:w-[35vw] 2xl:w-[48vw] xl:w-[45vw] lg:w-[48vw] md:w-[60vw] pr-8">
                <div className="overflow-hidden relative 3xl:h-[550px] 2xl:h-[350px] xl:h-[300px] lg:h-[350px]">
                  <img src="https://res.cloudinary.com/dzi3u164c/image/upload/v1774865116/Asset_1_qgly6y.webp" alt="About Prographr" className="w-full h-full object-cover" />
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-[92%] px-5 py-6 z-10 flex items-center" style={{ backgroundColor: "rgba(100, 138, 90, 0.88)", minHeight: "80px" }}>
                    <p className="3xl:text-[13px] 2xl:text-[11px] xl:text-[9.5px] lg:text-[9.5px] leading-[1.6] text-white">Our agency specializes in a wide range of design services that help brands stand out in a competitive market. From flyer design to full brand identity, we create meaningful visuals that drive results.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="shrink-0 flex items-start pt-2 pb-5">
              <div className="3xl:w-[35vw] 2xl:w-[48vw] xl:w-[45vw] lg:w-[48vw] md:w-[60vw] pr-8">
                <div className="overflow-hidden relative 3xl:h-[550px] 2xl:h-[350px] xl:h-[300px] lg:h-[350px]">
                  <img src="https://res.cloudinary.com/dzi3u164c/image/upload/v1774967188/photo-1556761175-b413da4baf72_iqjccn.avif" alt="We have an expert team" className="w-full h-full object-cover grayscale" />
                  <div className="absolute bottom-6 left-6 w-[40%] px-6 py-6 z-10 flex items-center" style={{ backgroundColor: "rgba(114, 163, 100, 0.9)", minHeight: "90px" }}>
                    <p className="text-white text-[15px] font-normal tracking-wide whitespace-nowrap">We have an expert team</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="shrink-0 self-stretch flex flex-col justify-start px-10 pt-2 3xl:w-[45vw] 2xl:w-[48vw] xl:w-[45vw] lg:w-[48vw] md:w-[60vw]">
              <h3 className="3xl:text-[52px] 2xl:text-[50px] xl:text-[40px] lg:text-[38px] font-normal text-[#0a0a0a] 2xl:leading-[1.4] xl:leading-[1.33] lg:leading-[1.4] mb-8 3xl:mt-8 2xl:mt-6 xl:mt-6 lg:mt-6">
                What makes<br /><span className="2xl:whitespace-nowrap">our agency different</span>
              </h3>
              <div className="flex items-start gap-4 3xl:pt-16 2xl:pt-16 xl:pt-8 lg:pt-20">
                <div className="flex-1">
                  <div className="3xl:text-[72px] 2xl:text-[40px] xl:text-[35px] lg:text-[32px] font-semibold leading-none mb-2 tracking-[-1px] 3xl:pt-20 2xl:pt-6 xl:pt-10 lg:pt-10 text-[#73AC56]">30+</div>
                  <div className="3xl:text-[16px] 2xl:text-[11px] xl:text-[12px] lg:text-[9px] leading-[1.5] text-[#292929] font-normal">Company with Work Experiences</div>
                </div>
                <div className="flex-[2] bg-[#182F33] 3xl:px-8 3xl:py-20 2xl:px-7 2xl:py-7 xl:px-4 xl:py-9 lg:px-2 lg:py-11 flex 3xl:gap-52 2xl:gap-40 xl:gap-14 lg:gap-6 items-center justify-center">
                  <div className="2xl:px-0 xl:px-0 lg:px-2">
                    <div className="3xl:text-[72px] 2xl:text-[40px] xl:text-[40px] lg:text-[30px] font-semibold leading-none mb-2 tracking-[-1px] text-[#73AC56]">1K+</div>
                    <div className="3xl:text-[20px] 2xl:text-[14px] xl:text-[10px] lg:text-[10px] leading-[1.5] text-white whitespace-nowrap">Job Completed</div>
                  </div>
                  <div>
                    <div className="3xl:text-[72px] 2xl:text-[40px] xl:text-[40px] lg:text-[30px] font-semibold leading-none mb-2 tracking-[-1px] text-[#73AC56]">100%</div>
                    <div className="3xl:text-[20px] 2xl:text-[14px] xl:text-[10px] lg:text-[10px] leading-[1.5] text-white whitespace-nowrap">Satisfied Client</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="shrink-0 mx-6 3xl:w-[40vw] 2xl:w-[48vw] xl:w-[45vw] lg:w-[48vw] md:w-[60vw]">
              <div className="relative 3xl:h-[552px] 2xl:h-[360px] xl:h-[303px] lg:h-[358px] overflow-hidden">
                <img src="https://res.cloudinary.com/dzi3u164c/image/upload/v1774931324/Asset_3_raki8b.webp" alt="CTA" className="absolute inset-0 w-full h-full object-cover" />
                ...
                <div className="absolute inset-0 z-[2] flex flex-col justify-between 3xl:p-16 2xl:p-16 xl:p-8 lg:p-8">
                  <h3 className="3xl:text-[58px] 2xl:text-[40px] xl:text-[36px] lg:text-[36px] font-extrabold text-white leading-[1.1] tracking-[-0.5px] 3xl:max-w-[360px] 2xl:max-w-[360px] xl:max-w-[360px] lg:max-w-[360px]">
                    Scroll and <br />enjoy a <br />new <br />experience
                  </h3>
