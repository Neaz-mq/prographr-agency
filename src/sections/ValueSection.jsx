    ...
    <section ref={containerRef} className="w-full bg-white" style={{ position: "relative" }}>
      <div className="md:py-12 py-7 3xl:py-44 2xl:py-16 xl:py-16 lg:py-16 px-6 md:px-10 3xl:px-[26rem] 2xl:px-[10rem] xl:px-[5rem] lg:px-[4rem]">
        ...
        <div className="overflow-hidden pb-20">
          <h2
            ref={headingRef}
            className="3xl:text-[clamp(52px,10vw,90px)] 2xl:text-[clamp(52px,10vw,80px)] xl:text-[clamp(45px,3.8vw,58px)] lg:text-[clamp(40px,3.8vw,58px)] md:text-[clamp(36px,3.8vw,58px)] text-[clamp(28px,10vw,40px)] font-semibold leading-[1.1] text-[#0a0a0a] tracking-[0.02em]"
          >
            What value
            <br />are you
            <br />getting from
