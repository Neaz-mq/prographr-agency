...
export default function Hero() {
  return (
    <section className="relative h-[100vh] overflow-visible flex flex-col z-0">
      ...
      {/* Content */}
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center  mx-auto w-full px-6 md:px-10 3xl:top-0 2xl:top-0 xl:-top-16 lg:-top-14 md:-top-14 -top-7">
