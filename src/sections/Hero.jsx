  ...
  return (
    <section className="relative h-[100vh] overflow-visible flex flex-col z-0">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center max-w-7xl mx-auto w-full px-6 md:px-10 3xl:-top-24 2xl:-top-16 xl:-top-16 lg:-top-14 md:-top-14 -top-7">
        ...
        <motion.h1
          {...fadeUp(0.1)}
          className="font-medium text-white leading-[1.65] sm:leading-[1.35] 3xl:leading-[1.25] 2xl:leading-[1.25] xl:leading-[1.25] lg:leading-[1.25] md:leading-[1.45] text-center text-[1.7rem] sm:text-[2.8rem] md:text-[3.2rem] lg:text-[4rem] xl:text-[4.2rem] 2xl:text-[4.5rem] 3xl:text-[6rem]"
        >
          Crafting Digital
          <br />
