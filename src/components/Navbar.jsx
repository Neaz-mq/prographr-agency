...
export default function Navbar() {
  ...
  return (
   <header className="absolute top-0 left-0 right-0 z-50 px-3 md:px-10 3xl:px-[26rem] 2xl:px-[10rem] xl:px-20 lg:px-14 pt-[40px] 3xl:pt-[60px] 2xl:pt-[52px] xl:pt-[45px] lg:pt-[40px]">
